...
class activeMessageButtonClass(BaseWidget):
    ...
    def widgetUI(self, parent):
        ...
        self.defaultStyle(
            elem, {"background-color": "offColor"}, {"background-color": "onColor"}
        )
        ...
        if (
            "pressValue" in self.widget.props
            and isinstance(self.widget.props["pressValue"], str)
        ) and (
            "releaseValue" in self.widget.props
            and isinstance(self.widget.props["releaseValue"], str)
        ):
        ...
        elif "pressValue" in self.widget.props and isinstance(
            self.widget.props["pressValue"], str
        ):
            self.property(elem, "clickText", "pressValue", "string")
        elif "releaseValue" in self.widget.props and isinstance(
            self.widget.props["releaseValue"], str
        ):
