...
class activeChoiceButtonClass(BaseWidget):
    ...
    def __init__(self, widget):
        ...
        if self.framework() == "EpicsQt":
            ...
            if h < 40:
                self.logger.warn(
                    'QERadioGroup "%s": Height (%d) is less than the minimum (%d).  Please examine this element in Qt Designer and adjust as necessary.'
                    % (self.widgetName(), h, 40)
                )
